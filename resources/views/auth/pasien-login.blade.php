...
<head>
    ...
    <title>Login Pasien - Klinik Medika</title>
    ...
    <div class="w-full max-w-md px-6">
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <div class="text-center mb-8">
                <h3 class="text-2xl font-bold text-black">Login Pasien</h3>
                <p class="text-gray-500 mt-2 text-sm">Masuk untuk melihat riwayat kunjungan Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.pasien.post') }}" class="space-y-6">
                @csrf

                <div>
                    <label for="login_id" class="block text-sm font-bold text-gray-700 mb-2">Nomor NIK</label>
