...
<head>
    ...
    <title>Login Perawat - Klinik Medika</title>
    ...
    <div class="w-full max-w-md px-6">
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <div class="text-center mb-8">
                <h3 class="text-2xl font-bold text-black">Login Perawat</h3>
                <p class="text-gray-500 mt-2 text-sm">Masuk untuk melihat antrean pasien</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.perawat.post') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="email" id="login_id" name="login_id" value="{{ old('login_id') }}" required
                        ...
                        placeholder="perawat@klinik.com">
                </div>
